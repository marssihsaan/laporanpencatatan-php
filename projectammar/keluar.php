...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Daftar Riwayat Laporan Keluar</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="exportkeluar.php" class= "btn btn-info">Cetak Laporan </a>
                            </div>
                            <div class="card-body">
     ...
     <div class="modal fade" id="myModal">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Tambah Laporan Keluar</h4>
        ...
        <select name="barangnya"class="form-control">
            ...
            <br>
            <input type="number" name="qty" placeholder="Jumlah Kerusakan" class="form-control" required>
            <br>
